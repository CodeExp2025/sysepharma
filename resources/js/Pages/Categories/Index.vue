...
const confirmDelete = (uuid) => {
    if (confirm('Supprimer cette catégorie ? Les médicaments associés ne seront pas supprimés.')) {
        router.delete(route('categories.destroy', uuid), { preserveScroll: true });
    }
};
</script>
                    ...
                    <div v-for="category in categories.data" 
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <Link v-if="category.uuid" :href="route('categories.edit', category.uuid)"
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button v-if="category.uuid" @click="confirmDelete(category.uuid)"
