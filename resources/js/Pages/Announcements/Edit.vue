...
const form = useForm({
    ...
    starts_at: formatDateTimeLocal(props.announcement.starts_at),
    ends_at: formatDateTimeLocal(props.announcement.ends_at),
    is_active: props.announcement.is_active,
});

const submit = () => {
    form.put(route('announcements.update', props.announcement.uuid));
};
