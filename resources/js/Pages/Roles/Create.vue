                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
                        ...
                        <div class="p-6">
                            <div>
                                ...
                                <p v-else class="mt-2 text-xs text-gray-500">Choisissez un nom descriptif pour ce rôle</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-2 text-sm text-blue-700">
                                            <p>Sélectionnez les permissions appropriées pour ce rôle. Vous pouvez cliquer sur une catégorie pour sélectionner/désélectionner toutes les permissions de cette catégorie.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
