...
<template>
    <Head title="Mot de passe oublié — Sys E-Dépôt Pharma" />
    ...
    <div class="auth-page">
        ...
        <div class="auth-card">
            ...
            <p class="card-desc">Saisissez votre adresse e-mail et nous vous enverrons un lien pour réinitialiser votre mot de passe.</p>
                ...
                <div class="field-group">
                    ...
                    <div class="field-wrap">
                        ...
                        <input
                            ...
                            :class="['auth-input', { 'has-error': form.errors.email }]"
                        />
                    </div>
...
.status-success {
    ...
    border-radius: 0.75rem; color: #15803d; font-size: 0.875rem; font-weight: 500;
    margin-bottom: 1rem; width: 100%; max-width: 26rem;
}
.status-success svg { width: 1.125rem; height: 1.125rem; flex-shrink: 0; }
...
.back-link {
    ...
    font-size: 0.875rem; color: #6b7280; text-decoration: none; font-weight: 500;
