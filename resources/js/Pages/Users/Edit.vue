...
const form = useForm({
    ...
    pharmacy_id: props.user.pharmacy_id || '',
    depot_id: props.user.depot_id || '',
});
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2" for="password">
                                        ...
                                        <span class="text-gray-400 text-xs font-normal">(laisser vide pour conserver)</span>
                                    </label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div v-show="showDepotField">
                                    ...
                                    <p v-else-if="showDepotField && !form.pharmacy_id" class="mt-2 text-xs text-amber-600">
                                        Sélectionnez d'abord une pharmacie pour filtrer les dépôts
                                    </p>
